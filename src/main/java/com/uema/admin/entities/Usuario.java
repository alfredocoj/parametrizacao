...
public class Usuario {
    ...
    @JoinTable(name="seg_perfis_usuarios", joinColumns={@JoinColumn(name="usr_id", referencedColumnName = "pru_usr_id")}, inverseJoinColumns={@JoinColumn(name="prf_id", referencedColumnName = "pru_prf_id")})
